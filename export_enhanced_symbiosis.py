...
if __name__ == "__main__":
    from scripts.improve_symbiotic_matching import generate_matches, export_to_jsonl

    print("Running improved symbiotic matching algorithm...")
    matches = generate_matches()

    export_to_jsonl(matches, "exports/improved_symbiotic_matches.jsonl")

    print(f"\nGenerated {len(matches)} symbiotic matches")
    print("Output: exports/improved_symbiotic_matches.jsonl")
